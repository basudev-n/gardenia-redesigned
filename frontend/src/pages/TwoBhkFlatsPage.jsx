          ...
          <div className="container mx-auto px-4 py-14">
            <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { icon: Building2, title: "Modern Family", text: "Comfort with practicality" },
                  { icon: Leaf, title: "Wellness", text: "Green and open surroundings" },
                  { icon: MapPin, title: "Ghangapatna", text: "Prime residential corridor" },
                  { icon: Sparkles, title: "Elegant Finish", text: "Refined interiors and details" },
                ].map((item) => {
